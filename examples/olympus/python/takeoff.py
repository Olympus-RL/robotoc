...
q_standing = np.array([0., 0., 0.4, 0., 0., 0., 1.0, 
                         0.0,  0.2,  0.8,  #back left
                        -0.0, -0.2,  0.8, #back right
                        -0.0,  0.2, -0.8, #front left
                         0.0,  0.2, -0.8]) #front right
q_ref = q_standing.copy()
q_ref[2] += 3.0
q_weight = np.array([0., 0., 1., 1.0, 1.0, 1.0, 
                        0.001, 0.001, 0.001, 
                        0.001, 0.001, 0.001,
                        0.001, 0.001, 0.001,
                        0.001, 0.001, 0.001])
...
config_cost.set_q_weight_terminal(q_weight*100)
...
sto_constraints = robotoc.STOConstraints(minimum_dwell_times=[0.10,0.6],
