...
int main()
{
  ...
  //const std::string urdf_file("/home/bolivar/OLYMPOC/robotoc/descriptions/olympus_description/urdf/olympus.urdf");
  ...
  switch (MODEL_NAME)
  {
    case 0:
      FR_FOOT = "RF_FOOT";
      FL_FOOT = "LF_FOOT";
      urdf_file = std::string("/home/bolivar/OLYMPOC/robotoc/examples/anymal/anymal_b_simple_description/urdf/anymal.urdf");
  ...
  std::cout << "dv_dv error: " << (d_v_dv.template topRows<3>() - d_v_dv_ref).norm() << std::endl;
  std::cout << "da_dq error: " << (d_a_dq.template topRows<3>() - d_a_dq_ref).norm() << std::endl;
  std::cout << "da_dv error: " << (d_a_dv.template topRows<3>() - d_a_dv_ref).norm() << std::endl;
  std::cout << "da_da error: " << (d_a_da.template topRows<3>() - d_a_da_ref).norm() << std::endl;
  std::cout << "====================================" << std::endl;
