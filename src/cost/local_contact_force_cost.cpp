...
LocalContactForceCost::LocalContactForceCost(const Robot &robot)
    : CostFunctionComponentBase(), max_num_contacts_(robot.maxNumContacts()),
      max_dimf_(robot.max_dimf()), contact_types_(robot.contactTypes()),
...
LocalContactForceCost::LocalContactForceCost()
    : CostFunctionComponentBase(), max_num_contacts_(0), max_dimf_(0),
      contact_types_(), f_ref_(), f_weight_(), fi_ref_(), fi_weight_() {}
...
double LocalContactForceCost::evalImpactCost(Robot &robot,
