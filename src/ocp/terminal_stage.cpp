...
TerminalStage::TerminalStage() : cost_(), constraints_(), contact_sequence_() {}
...
void TerminalStage::evalOCP(Robot &robot, const GridInfo &grid_info,
  ...
  data.performance_index.cost =
      cost_->evalTerminalCost(robot, data.cost_data, grid_info, s);
  // constraints_->evalConstraint(robot, contact_status, data.constraints_data,
  // s); data.performance_index.cost_barrier =
  // data.constraints_data.logBarrier(); summarize evaluations
...
void TerminalStage::evalKKT(Robot &robot, const GridInfo &grid_info,
  ...
  data.performance_index.setZero();
  // eval cost and constraints
  data.performance_index.cost = cost_->quadratizeTerminalCost(
      robot, data.cost_data, grid_info, s, kkt_residual, kkt_matrix);
