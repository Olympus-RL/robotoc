...
PYBIND11_MODULE(impact_status, m) {
  py::class_<ImpactStatus>(m, "ImpactStatus")
      ...
      .def(py::init<>())
      .def("dimf", &ImpactStatus::dimf)
      .def("max_num_contacts", &ImpactStatus::maxNumContacts)
      .def("is_impact_active",
           static_cast<bool (ImpactStatus::*)(const int) const>(
               &ImpactStatus::isImpactActive),
           py::arg("contact_index"))
      .def("is_impact_active",
           static_cast<const std::vector<bool> &(ImpactStatus::*)() const>(
               &ImpactStatus::isImpactActive))
      ...
      .def("set_contact_placement",
           static_cast<void (ImpactStatus::*)(const int,
                                              const Eigen::Vector3d &)>(
               &ImpactStatus::setContactPlacement),
           py::arg("contact_index"), py::arg("contact_position"))
      .def("set_contact_placement",
           static_cast<void (ImpactStatus::*)(
      ...
      .def("set_contact_placements",
           static_cast<void (ImpactStatus::*)(
               ...
               &ImpactStatus::setContactPlacements),
      ...
      .def("set_friction_coefficient",
           static_cast<void (ImpactStatus::*)(const int, const double)>(
               &ImpactStatus::setFrictionCoefficient),
           py::arg("contact_index"), py::arg("friction_coefficient"))
      .def("set_friction_coefficient",
           static_cast<void (ImpactStatus::*)(const std::string &,
                                              const double)>(
               &ImpactStatus::setFrictionCoefficient),
           py::arg("contact_frame_name"), py::arg("friction_coefficient"))
      .def("set_friction_coefficients",
           static_cast<void (ImpactStatus::*)(const std::vector<double> &)>(
               &ImpactStatus::setFrictionCoefficients),
      ...
      .def("friction_coefficient",
           static_cast<double (ImpactStatus::*)(const int) const>(
               &ImpactStatus::frictionCoefficient),
           py::arg("contact_index"))
      .def("friction_coefficient",
           static_cast<double (ImpactStatus::*)(const std::string &) const>(
               &ImpactStatus::frictionCoefficient),
