...
PYBIND11_MODULE(robot_model_info, m) {
  ...
  py::class_<RobotModelInfo>(m, "RobotModelInfo")
      ...
      .def_static("Manipulator", &RobotModelInfo::Manipulator,
                  py::arg("urdf_path"))
      .def_static("Quadruped", &RobotModelInfo::Quadruped, py::arg("urdf_path"),
                  py::arg("point_contacts"))
      .def_static("Humanoid", &RobotModelInfo::Humanoid, py::arg("urdf_path"),
                  py::arg("surface_contacts"))
