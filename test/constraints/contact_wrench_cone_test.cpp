...
void ContactWrenchConeTest::test_kinematics(
...
void ContactWrenchConeTest::test_isFeasible(
    Robot &robot, const ContactStatus &contact_status) const {
  ContactWrenchCone constr(robot, X, Y);
...
void ContactWrenchConeTest::test_setSlack(
    Robot &robot, const ContactStatus &contact_status) const {
  ContactWrenchCone constr(robot, X, Y);
  ConstraintComponentData data(constr.dimc(), constr.getBarrierParam()),
  ...
  std::cout << "data.slack - data_ref.slack: "
            << (data.slack - data_ref.slack).transpose() << std::endl;
  std::cout << "data.residual- data_ref.residual: "
            << (data.residual - data_ref.residual).transpose() << std::endl;
}

void ContactWrenchConeTest::test_evalConstraint(
    Robot &robot, const ContactStatus &contact_status) const {
  ContactWrenchCone constr(robot, X, Y);
  const int dimc = constr.dimc();
  const auto s = SplitSolution::Random(robot, contact_status);
...
void ContactWrenchConeTest::test_evalDerivatives(
    Robot &robot, const ContactStatus &contact_status) const {
  ContactWrenchCone constr(robot, X, Y);
  ConstraintComponentData data(constr.dimc(), constr.getBarrierParam());
  constr.allocateExtraData(data);
...
void ContactWrenchConeTest::test_condenseSlackAndDual(
    Robot &robot, const ContactStatus &contact_status) const {
  ContactWrenchCone constr(robot, X, Y);
  ConstraintComponentData data(constr.dimc(), constr.getBarrierParam());
  constr.allocateExtraData(data);
...
void ContactWrenchConeTest::test_expandSlackAndDual(
    Robot &robot, const ContactStatus &contact_status) const {
  ContactWrenchCone constr(robot, X, Y);
  ConstraintComponentData data(constr.dimc(), constr.getBarrierParam());
  constr.allocateExtraData(data);
