...
inline void PointContact::computeBaumgarteResidual(
  ...
  const_cast<Eigen::MatrixBase<VectorType2> &>(baumgarte_residual).noalias() =
      pinocchio::getFrameClassicalAcceleration(model, data, contact_frame_id_,
                                               pinocchio::LOCAL)
          .linear();
  (const_cast<Eigen::MatrixBase<VectorType2> &>(baumgarte_residual))
      .noalias() += info_.baumgarte_velocity_gain *
  ...
  (const_cast<Eigen::MatrixBase<VectorType2> &>(baumgarte_residual))
      ...
      data.oMf[contact_frame_id_].rotation().transpose() *
      (data.oMf[contact_frame_id_].translation() - desired_contact_position);
}

template <typename VectorType1, typename MatrixType1, typename MatrixType2,
...
inline void PointContact::computeBaumgarteDerivatives(
  ...
  pinocchio::getFrameAccelerationDerivatives(
      model, data, contact_frame_id_, pinocchio::LOCAL, frame_v_partial_dq_,
  ...
  pinocchio::skew(data.oMf[contact_frame_id_].rotation().transpose() *
                      desired_contact_position,
                  Rtx_skew_);
  pinocchio::skew(data.oMf[contact_frame_id_].rotation().transpose() *
                      data.oMf[contact_frame_id_].translation(),
                  Rtp_skew_);
  const_cast<Eigen::MatrixBase<MatrixType1> &>(baumgarte_partial_dq) =
      frame_a_partial_dq_.template topRows<3>();
  const_cast<Eigen::MatrixBase<MatrixType1> &>(baumgarte_partial_dq)
      .noalias() += v_angular_skew_ * frame_v_partial_dq_.template topRows<3>();
  const_cast<Eigen::MatrixBase<MatrixType1> &>(baumgarte_partial_dq)
      .noalias() -=
  ...
  const_cast<Eigen::MatrixBase<MatrixType2> &>(baumgarte_partial_dv)
      .noalias() += v_angular_skew_ * J_frame_.template topRows<3>();
  const_cast<Eigen::MatrixBase<MatrixType2> &>(baumgarte_partial_dv)
      .noalias() -= v_linear_skew_ * J_frame_.template bottomRows<3>();
  const_cast<Eigen::MatrixBase<MatrixType3> &>(baumgarte_partial_da) =
      frame_a_partial_da_.template topRows<3>();
  (const_cast<Eigen::MatrixBase<MatrixType1> &>(baumgarte_partial_dq))
      .noalias() +=
      info_.baumgarte_velocity_gain * frame_v_partial_dq_.template topRows<3>();
  (const_cast<Eigen::MatrixBase<MatrixType2> &>(baumgarte_partial_dv))
      .noalias() +=
      info_.baumgarte_velocity_gain * frame_a_partial_da_.template topRows<3>();
  (const_cast<Eigen::MatrixBase<MatrixType1> &>(baumgarte_partial_dq))
      .noalias() +=
      info_.baumgarte_position_gain * J_frame_.template topRows<3>();
  (const_cast<Eigen::MatrixBase<MatrixType3> &>(baumgarte_partial_dq))
      .noalias() += info_.baumgarte_position_gain * (Rtp_skew_ - Rtx_skew_) *
                    J_frame_.template bottomRows<3>();
}
...
inline void PointContact::computeContactVelocityDerivatives(
  ...
  pinocchio::getFrameVelocityDerivatives(model, data, contact_frame_id_,
                                         pinocchio::LOCAL, frame_v_partial_dq_,
                                         frame_a_partial_da_);
  (const_cast<Eigen::MatrixBase<MatrixType1> &>(velocity_partial_dq))
      .noalias() = frame_v_partial_dq_.template topRows<3>();
  (const_cast<Eigen::MatrixBase<MatrixType2> &>(velocity_partial_dv))
      .noalias() = frame_a_partial_da_.template topRows<3>();
}
