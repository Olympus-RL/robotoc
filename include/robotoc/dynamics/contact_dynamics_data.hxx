...
inline void
ContactDynamicsData::setSwitchingConstraintDimension(const int dims) {
  assert(dims >= 0);
  dims_ = dims;
}

inline int ContactDynamicsData::dimv() const { return dimv_; }

inline int ContactDynamicsData::dimu() const { return dimu_; }

inline int ContactDynamicsData::dimf() const { return dimf_; }

inline int ContactDynamicsData::dimvf() const { return dimvf_; }

inline int ContactDynamicsData::dims() const { return dims_; }

inline int ContactDynamicsData::dim_passive() const { return dim_passive_; }
...
inline const Eigen::Block<const Eigen::MatrixXd>
ContactDynamicsData::Phia() const {
  return Phia_full_.topLeftCorner(dims_, dimv_);
}
