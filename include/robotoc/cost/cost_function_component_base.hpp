...
///
class CostFunctionComponentBase
    : public std::enable_shared_from_this<CostFunctionComponentBase> {
public:
  ///
  ...
  ///
  CostFunctionComponentBase &
  operator=(const CostFunctionComponentBase &) = default;
  ...
  ///
  CostFunctionComponentBase &
  operator=(CostFunctionComponentBase &&) noexcept = default;
  ...
  /// @return Stage cost.
  ///
  virtual double evalStageCost(Robot &robot,
  ...
  ///
  virtual void
  evalStageCostDerivatives(Robot &robot, const ContactStatus &contact_status,
  ...
  /// @return Impact cost.
  ///
  virtual double evalImpactCost(Robot &robot, const ImpactStatus &impact_status,
                                CostFunctionData &data,
                                const GridInfo &grid_info,
                                const SplitSolution &s) const = 0;
  ...
  ///
  virtual void
  evalImpactCostDerivatives(Robot &robot, const ImpactStatus &impact_status,
                            CostFunctionData &data, const GridInfo &grid_info,
                            const SplitSolution &s,
                            SplitKKTResidual &kkt_residual) const = 0;
  ...
  ///
  template <typename Derived> std::shared_ptr<Derived> as_shared_ptr() {
  ...
  virtual void discretize(const Robot &robot,
